  ...
  return (
    <div className="fixed inset-0 bg-black flex flex-col z-[9998]">
      ...
      <div className="relative flex-1 w-full h-full">
        ...
        <div className="absolute top-6 left-6 bg-black bg-opacity-60 px-4 py-2 rounded-lg shadow-lg">
        ...
        <div className="absolute top-6 right-6 flex flex-col items-end gap-2">
          {/* Call duration */}
          <div className="bg-black bg-opacity-60 px-4 py-2 rounded-lg shadow-lg">
          ...
          {connectionQuality !== 'unknown' && (
            <div className="flex items-center gap-2 bg-black bg-opacity-60 px-3 py-2 rounded-lg shadow-lg">
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          {isMobile && (
            <button
              ...
              className="w-14 h-14 rounded-full flex items-center justify-center transition-all shadow-xl bg-white bg-opacity-20 hover:bg-opacity-30 active:scale-95"
          ...
          <button
            onClick={onEndCall}
            className="w-16 h-16 rounded-full bg-red-600 hover:bg-red-700 active:scale-95 focus:ring-4 focus:ring-red-500 focus:ring-opacity-50 shadow-2xl flex items-center justify-center transition-all"
            aria-label="End call"
            title="End call"
          >
            <svg
